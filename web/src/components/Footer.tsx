...
export function Footer() {
  return (
    <footer className="border-t border-slate-200 dark:border-slate-800/80 bg-slate-50 dark:bg-[#090d16] mt-auto transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-bold text-slate-900 dark:text-white tracking-tight">TEKSHIR PLATFORMASI</span>
            </div>
        ...
        <div className="pt-6 border-t border-slate-200 dark:border-slate-800/80 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 dark:text-slate-400 gap-4">
          ...
          <div className="flex items-center gap-4">
            <span>Versiya: MVP v1.1 Pro</span>
            <span>•</span>
